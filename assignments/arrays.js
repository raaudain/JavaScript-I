...
// In case the id's aren't in order

let car33 = [];

for(let i=0; i<inventory.length; i++){
    if(inventory[i].id.valueOf() == "33".valueOf()){
...
console.log("Make: "+lastCar.car_make+"\nModel: "+lastCar.car_model);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

const carModels = inventory.sort((a,b) => {return a.car_model > b.car_model;});
...
for(let i = 0; i<inventory.length; i++){
    if(inventory[i].car_year.valueOf() < "2000".valueOf()){
...
for(let i = 0; i<inventory.length; i++){
    if (inventory[i].car_make.valueOf() === "BMW".valueOf() || inventory[i].car_make.valueOf() === "Audi".valueOf()){
